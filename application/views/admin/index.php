...
<head>
	...
	<title>APPELSA - <?php print $title; ?></title>
	...
	<div class="left side-menu">
		...
		<div class="left-side-logo d-block d-lg-none">
			<div class="text-center">
				...
				<a href="index.html" class="logo"><img src="<?php print base_url() ?>assets/admin/images/logo-dark.png" height="20" alt="logo"></a>
			</div>
		</div>
			...
			<div class="topbar">
				...
				<div class="topbar-left	d-none d-lg-block">
					<div class="text-center">
						...
						<a href="index.html" class="logo"><img src="<?php print base_url() ?>assets/admin/images/logo.png" height="20" alt="logo"></a>
					</div>
				</div>
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-menu-lg">
								...
								<div class="slimscroll" style="max-height: 230px;">
									...
									<a href="javascript:void(0);" class="dropdown-item notify-item">
										<div class="notify-icon"><img src="<?php print base_url() ?>assets/admin/images/users/user-2.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
									...
									<!-- item-->
									<a href="javascript:void(0);" class="dropdown-item notify-item">
										<div class="notify-icon"><img src="<?php print base_url() ?>assets/admin/images/users/user-3.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
										<p class="notify-details"><b>Thomas J. Mimms</b><span class="text-muted">You have 87 unread messages</span></p>
									</a>

									<!-- item-->
									<a href="javascript:void(0);" class="dropdown-item notify-item">
										<div class="notify-icon"><img src="<?php print base_url() ?>assets/admin/images/users/user-4.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
										<p class="notify-details">Luis M. Konrad<span class="text-muted">It is a long established fact that a reader will</span></p>
									</a>

									<!-- item-->
									<a href="javascript:void(0);" class="dropdown-item notify-item">
										<div class="notify-icon"><img src="<?php print base_url() ?>assets/admin/images/users/user-5.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
									...
									<!-- item-->
									<a href="javascript:void(0);" class="dropdown-item notify-item">
										<div class="notify-icon"><img src="<?php print base_url() ?>assets/admin/images/users/user-6.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
								...
								<div class="card-body">
									...
									<ul class="list-unstyled activity-list">
										...
										<li class="activity-item">
											...
											<div>
												<a href="#" class="activity-item-img"><img src="<?php print base_url() ?>assets/admin/images/small/img-1.jpg" alt="" class="rounded mb-2"></a>
												<a href="#" class="activity-item-img"><img src="<?php print base_url() ?>assets/admin/images/small/img-2.jpg" alt="" class="rounded mb-2"></a>
											</div>
										</li>
										<li class="activity-item">
