							...
							<div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
								<div class="pull-right">
									...
									if($getdata[0]->orderStatus!="paid" ){
										?><a href="<?php print base_url('OrderControl/Adddetailfancy/'.$id); ?>"
											 class="btn btn-primary fancybox-frame"><i class="fa fa-plus"></i> Tambah Detail Orders</a><?php
									}
								...
								<div class="pull-left">
									...
									<a href="<?php print base_url("OrderControl/"); ?>" class="btn btn-warning" style="margin-bottom: 20px;"><i class="fa fa-angle-double-left"></i> Kembali</a><br>
								</div>
							</div>
						</div>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<table class="table borderless">
											...
											<tr>
												<td width="20%"><?php print _('No. Invoice'); ?></td>
												<td>:</td>
												<td><strong><?php print $getdata[0]->orderPCC; ?></strong></td>
											</tr>
											<tr class="text-left">
												<td><?php print _('Tanggal Pesanan'); ?></td>
												<td>:</td>
												<td><strong><?php print date("d F Y",$getdata[0]->orderTimestamp); ?></strong></td>
											</tr>
