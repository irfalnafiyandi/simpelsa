				...
				<div class="box">
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
								<div class="pull-right">
									<a href="<?php print base_url('Mview'); ?>/addmember" class="btn btn-primary "><i class="fa fa-plus"></i> Tambah</a>
								</div>
							</div>
						</div>
						...
						<div class="row block-break mb-20">
							<div class="col-md-12">
								<div class="pull-right">
									<form method="post" action="<?php print  base_url('Mview/member') ?>" class="form-inline" name="add" id="add">
							...
							<div class="panel-body table-responsive">
								<table id="example1" class="table table-bordered table-striped table-hover border-table">
									...
									<tr>
										...
										<th width="25%" class="success border-table backgroundtable">No WhatsApp</th>
									...
									if($rows < 1 ){
										...
										foreach ($query as $key => $value) {
											...
											<tr>
												...
												<td class="text-left border-table"><?php print $value->mName; ?></td>
												<td class="text-left border-table"><b><?php print $value->mEmail; ?></b></td>
												<td class="text-left border-table"><b><?php print $value->mWA; ?></b></td>
												<td class="text-center border-table">
													<a href="<?php print base_url("/Mview/Editmember/".$value->mId); ?>" class=""><i class="fa fa-pencil-square" style=""></i></a></td>
												<td class="text-center border-table">
													<a href="javascript:if (window.confirm('<?php print "Apakah anda yakin untuk hapus akun ini?"; ?>')){ window.location='<?php print base_url('Mcontrol/Cdeletemember/'.$value->mId) ?>'; };" style="color:red "><i class="fa fa-trash" ></i></a>
												</td>
