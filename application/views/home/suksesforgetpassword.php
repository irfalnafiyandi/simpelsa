				...
				<div class="col-sm-12 ">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="alert success mb-0 font-weight-bold" role="alert"   ><h4>Email reset password berhasil dikirim, Silakah Check Email Anda untuk melakukan reset password.</h4></div>
						</div>
					</div>
