...
<div class="page" id="top">
	...
	<section class="page-section padding-section " id="success" style="padding-top: 40px;padding-bottom: 40px;">
		<div class="container relative">
			...
			<div class="row">
				<div class="col-sm-12 ">
					<div class="alert success" role="alert" >Berhasil Melakukan Pelaporan Sampah, <a href="<?php print base_url('Home/Laporan#laporan') ?>">Klik Disini Untuk Melakukan pelaporan Kembali !</a></div>
				</div>
