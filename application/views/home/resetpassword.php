		...
		<div class="container relative">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
					<div class="section-title">
						Reset Password<span class="st-point">.</span>
					</div>
			...
			<div class="row">
				...
				<div class="col-sm-4 mb-40">
					...
					<form method="post" action="<?php echo base_url('resetpassword/proses'); ?>" id="form" role="form"
						  class="form"  style="text-transform: none">

						<div class="mb-20 mb-md-10">
							<!-- Password -->
							<input name="code" value="<?php print $code ?>" type="hidden">
							<input type="password" name="password" id="password" class="form-control"
								   placeholder="Password Baru" maxlength="100" required>
						</div>
						<div class="mb-20 mb-md-10">
							<!-- Password -->
							<input type="password" name="password2" id="password2" class="form-control"
								   placeholder="Konfirmasi Password Baru" maxlength="100" required>
						</div>
