<script>
	...
	$(document).ready(function () {
		$('#result').hide();
		validate("#addform", "<?php print site_url() . "/StockControl/CaddHistoryStock/".$id  ?>", "<?php print site_url() . "/StockControl/CaddHistoryStock/" . $id ?>/y");
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" name="sisa" id="sisa" placeholder="Masukan sisa" onkeypress="return isNumberKey(event)"
								   required   value="<?php print  number_format($valueedit->stockQty, 0, ',', '.') ;?>"  readonly>
						</div>
					</div>
					...
					<div class="form-group col-1">
						...
						<input type="number" class="form-control" name="jumlah" id="jumlah" autocomplete="jumlah" onkeypress="return isNumberKey(event)" onkeyup="totalstock();"
							   placeholder="Masukan  jumlah" required   style="width: 50%;"  min="0" value="<?php print  number_format($valueedit->stockQty, 0, ',', '.') ;?>" >
					</div>
