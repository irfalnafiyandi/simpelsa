...
<script>
	$(document).ready(function(){
		$('#result').hide();
		validate("#editform","<?php print site_url()."/KlasifikasiControl/CaddKodeKlasifikasi"  ?>","<?php print site_url()."/KlasifikasiControl/KodeKlasifikasi" ?>");
	});
</script>
											...
											<div class="panel-body">
												...
												<form class="col-md-6" id="editform" >
													...
													<div class="form-group">
														<label>Nama:</label>
														<input type="text" class="form-control" name="name" placeholder="Masukan nama kode"  required>
													</div>
													<div class="form-group">
														<label>Jenis :</label>
														<input type="text" class="form-control" name="jenis"   placeholder="Masukan jenis kode klasifikasi"  required>
													</div>
