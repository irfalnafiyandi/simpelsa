						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
								<div class="pull-right">
									<a href="<?php print base_url('SuratControl'); ?>/AddSuratKeluar" class="btn btn-primary "><i class="fa fa-plus"></i> Tambah</a>
								</div>
							</div>
						</div>
							...
							<div class="panel-body table-responsive">
								<table id="example1" class="table table-bordered table-striped table-hover border-table">
									...
									<tr>
										...
										<th width="20%" class="success border-table backgroundtable">Type</th>
									...
									if($rows < 1 ){
										...
										foreach ($query as $key => $value) {
											...
											<tr>
												...
												<td class="text-left border-table"><h4><b><?php
														if($value->sType=="naskahdinas"){
															?><span class="label label-success">Naskah Dinas</span><?php

														}elseif($value->sType=="produkhukum"){
															?><span class="label label-primary">Produk Hukum</span><?php
