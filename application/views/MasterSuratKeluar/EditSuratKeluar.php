...
<script>
	$(document).ready(function(){
		$('#result').hide();
		validate("#editform","<?php print site_url()."/SuratControl/CeditSuratKeluar/".$id  ?>","<?php print site_url()."/SuratKeluar/SuratKeluar" ?>");
	});
</script>
									...
									<div class="col-md-6">
										...
										<div class="panel panel-success">
											<div class="panel-body">
												...
												<input type="hidden" class="form-control" name="id"  value="<?php print $value2->SId; ?>" placeholder="Masukan nama admin"  required>
												...
												<div class="form-group">
													...
													<select class="form-control" name="jenis" id="jenis">\
														<option value="naskahdinas" <?php if($value2->sType=="naskahdinas"){ print "selected"; } ?>>Naskah Dinas</option>
														<option value="produkhukum" <?php if($value2->sType=="produkhukum"){ print "selected"; } ?>>Produk Hukum</option>
													</select>
												</div>
													<div class="form-group">
														<label>Code:</label>
														<input type="text" class="form-control" name="code" placeholder="Masukan code"  value="<?php print $value2->sCode; ?>" required>
													</div>
