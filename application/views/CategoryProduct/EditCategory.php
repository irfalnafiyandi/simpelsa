...
<script>
	$(document).ready(function(){
		$('#result').hide();
		validate("#editform","<?php print site_url()."/CategoryControl/CeditCategory/".$id  ?>","<?php print site_url()."/CategoryControl/" ?>");
	});
</script>
											...
											<div class="panel-body">
												...
												<form class="" id="editform" >
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" name="name"  value="<?php print $value2->cName; ?>" placeholder="Masukan nama admin"  required>
													</div>
