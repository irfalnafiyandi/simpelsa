						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
								<div class="pull-right">
									<a href="<?php print base_url('SatuanControl'); ?>/AddSatuan" class="btn btn-primary "><i class="fa fa-plus"></i> Tambah</a>
								</div>
							</div>
						</div>
								...
								<table id="example1" class="table table-bordered table-striped table-hover border-table">
									...
									foreach ($query as $key => $value) {
										...
										<tr>
											...
											<td class="text-left border-table"><?php print $value->spName; ?></td>
											<td class="text-center border-table">
												<a href="<?php print base_url("/SatuanControl/EditSatuan/".$value->spId); ?>" class=""><i class="fa fa-pencil-square" style=""></i></a></td>
											<td class="text-center border-table">
												<a class="delete" href="javascript:if (window.confirm('<?php print "Apakah anda yakin untuk hapus data ini?"; ?>')){ validate_delete('<?php print site_url()."/SatuanControl/CdeleteSatuan/".$value->spId ?>','<?php print site_url()."/SatuanControl/" ?>') };" style="color:red "><i class="fa fa-trash" ></i></a>
											</td>
