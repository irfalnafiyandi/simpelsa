<script>
	$(document).ready(function(){
		$('#result').hide();
		validate("#addform","<?php print site_url()."/ProductControl/CexportProduct" ?>","<?php print site_url()."/ProductControl/" ?>");
	});
</script>
									...
									<div class="col-md-6">
										...
										<div class="panel panel-success">
											<div class="panel-body">
												...
												print form_open_multipart('ProductControl/CexportProduct',$attributes); ?>
