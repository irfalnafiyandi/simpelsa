...
<script>
	$(document).ready(function(){
		$('#result').hide();
		validate("#editform","<?php print site_url()."/BidangControl/CaddBidang"  ?>","<?php print site_url()."/BidangControl/Bidang" ?>");
											...
											<div class="panel-body">
												...
												<form class="col-md-6" id="editform" >
													...
													<div class="form-group">
														<label>Nama:</label>
														<input type="text" class="form-control" name="name" placeholder="Masukan nama Bidang"  required>
													</div>
