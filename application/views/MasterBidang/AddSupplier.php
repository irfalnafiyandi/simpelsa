...
<script>
	$(document).ready(function(){
		$('#result').hide();
		validate("#editform","<?php print site_url()."/SupplierControl/CaddSupplier"  ?>","<?php print site_url()."/SupplierControl/" ?>");
										...
										<div class="panel panel-success">
											<div class="panel-body">
												...
												<form class="" id="editform" >
													...
													<div class="form-group">
														<label>No HP</label>
														<input type="text" class="form-control" name="hp" placeholder="Masukan no hp"  >
													</div>
													<div class="form-group">
														<label>Alamat </label>
