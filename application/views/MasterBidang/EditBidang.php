...
<script>
	$(document).ready(function(){
		$('#result').hide();
		validate("#editform","<?php print site_url()."/BidangControl/CeditBidang/".$id  ?>","<?php print site_url()."/BidangControl/Bidang" ?>");
	});
</script>
					...
					<div class="box-body">
						<div class="panel panel-default table-responsive">
							<div class="panel-body table-responsive">
								<div class="row">
									<div class="col-md-6">
										<a href="<?php print base_url("BidangControl/Bidang"); ?>" class="btn btn-lg btn-warning" style="margin-bottom: 20px;">Kembali</a><br>
										...
										<div class="panel panel-success">
											<div class="panel-body">
												...
												<div class="form-group">
													<label>Nama:</label>
													<input type="text" class="form-control" name="name"  value="<?php print $value2->bName; ?>" placeholder="Masukan nama admin"  required>
												</div>
