						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
								<div class="pull-right">
									<a href="<?php print base_url('BidangControl'); ?>/AddBidang" class="btn btn-primary "><i class="fa fa-plus"></i> Tambah</a>
								</div>
							</div>
						</div>
										...
										foreach ($query as $key => $value) {
											...
											<tr>
												...
												<td class="text-center border-table">
													<a href="<?php print base_url("/BidangControl/EditBidang/".$value->bId); ?>" class=""><i class="fa fa-pencil-square" style=""></i></a></td>
												<td class="text-center border-table">
													<a class="delete" href="javascript:if (window.confirm('<?php print "Apakah anda yakin untuk hapus data ini?"; ?>')){ validate_delete('<?php print site_url()."/BidangControl/CdeleteBidang/".$value->bId ?>','<?php print site_url()."/BidangControl/Bidang" ?>') };" style="color:red "><i class="fa fa-trash" ></i></a>
												</td>
